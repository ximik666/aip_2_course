...
![Пример](https://www.vipmind.me/images/python-virtualenv.png)
...
**Для компьютерного класса использовать другую команду для установки пакетов в виртуальное окружение**

```python
.\work_1\Scripts\pip.exe install numpy==1.1
```

Данная команда установить пакет numpy в виртуальное окружение work_1
